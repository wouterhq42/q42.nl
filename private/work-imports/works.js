[
  {
    "slug": "apple-watch-klm",
    "clientName": "KLM", // klant naam
    "name": "Apple Watch app", // project naam
    "slogan": "Check in from your wrist", // Engelse
    "slogan_nl": "Inchecken vanaf je pols", // Nederlandse
    ...
    "properties": {
      "pinned": true, // Op overzicht vastgezet of niet.
      "category": "project", // project, venture, jumpstart
      "qers": ["guus", "kamil"], // employee handles van de qers die eraan gewerkt hebben
      "contact": "timd", // employee handle van het contactpersoon
      "date": "2015-05-01",
      "tags": ["app", "apple-watch", "wearable", "travel", "ios", "swift"]
    },
    "things": []
  },
  ...
  {
    "slug": "philips-hue",
    "clientName": "Philips", // klant naam
    "name": "hue", // project naam
    "slogan": "Lighting for nerds", // Engelse
    "slogan_nl": "Lampen voor nerds", // Nederlandse
    ...
    "properties": {
      "pinned": true, // Op overzicht vastgezet of niet.
      "category": "project", // project, venture, jumpstart
      "qers": ["lukas", "christiaan", "arian"], // employee handles van de qers die eraan gewerkt hebben
      "contact": "taco", // employee handle van het contactpersoon
      "date": "2012-10-01",
      "tags": ["iot", "google-cloud-platform", "appengine", "java", "nodejs"]
    },
    "things": []
  },
  ...
  {
    "slug": "staatsloterij",
    "clientName": "Staatsloterij", // klant naam
    "name": "Website", // project naam
    "slogan": "Completely new website", // Engelse
    "slogan_nl": "De nieuwe website", // Nederlandse
    ...
    "properties": {
      ...
      "category": "project", // project, venture, jumpstart
      "qers": ["bas", "leonard", "sjoerd", "christiaan", "roelf-jan", "wouter", "michiel", "ted", "bob", "laurens"], // employee handles van de qers die eraan gewerkt hebben
      "contact": "gerard", // employee handle van het contactpersoon
      "date": "2013-06-01",
      "tags": ["website", "google-cloud-platform", "appengine", "java", "nodejs"]
    },
    "things": []
  },
  ...
  {
    "slug": "postnl",
    "clientName": "PostNL", // klant naam
    "name": "iOS & Android apps", // project naam
    "slogan": "Post office in your pocket", // Engelse
    "slogan_nl": "Postkantoor in je broekzak", // Nederlandse
    ...
    "properties": {
      "pinned": false, // Op overzicht vastgezet of niet.
      "category": "project", // project, venture, jumpstart
      "qers": ["tom", "mathijs", "tomas", "thijs", "sander", "bart"], // employee handles van de qers die eraan gewerkt hebben
      "contact": "gerard", // employee handle van het contactpersoon
      "date": "2014-03-01",
      "tags": ["app", "ios", "android", "swift", "java"]
    },
    "things": []
  },
  ...
  {
    "slug": "designmuseum",
    "clientName": "Design Museum", // klant naam
    "name": "Website", // project naam
    "slogan": "A beautiful exposition of great design", // Engelse
    "slogan_nl": "Fantastisch ontwerp in een fantastisch ontwerp", // Nederlandse
    ...
    "properties": {
      "pinned": false, // Op overzicht vastgezet of niet.
      "category": "project", // project, venture, jumpstart
      "qers": ["tim", "michiel", "mark", "guus", "guido"], // employee handles van de qers die eraan gewerkt hebben
      "contact": "korjan", // employee handle van het contactpersoon
      "date": "2014-10-01",
      "tags": ["website", ""]
    },
    "things": []
