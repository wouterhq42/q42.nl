 ...
 */
(function(){function c(a){this.data=a;this.id=a.id;this.width=a.width;this.height=a.height;this.path=a.path||"http://bin.micr.io/public/";this.L=a.tileSize||a.zoomify&&256||512;this.Ub=!1!==a.hookEvents;this.Sa="cover"==a.initType;this.Hb=!1!==a.autoInit;this.J=a.json||{};this.W=!a.noLevel0&&1||0;this.cc=a.zoomify;this.Jb=a.doubleClickZoomOut;this.Aa=navigator.h.ie9||navigator.h.iOS&&navigator.h.mobile;this.ya=navigator.h.ie||navigator.h.firefox||navigator.h.safari;this.Kb=this.Aa&&1||1;console.log("linefix??",
this.ya);this.aspect=this.width/this.height;for(var b=this.L;b<Math.max(this.width,this.height);b*=2,this.W++);this.ratio=this.Y=window.devicePixelRatioIEMobile||!this.Aa&&!a.noRetina&&window.devicePixelRatio&&Math.min(2,window.devicePixelRatio)||1;this.el=this.i=a.canvas instanceof Element&&a.canvas||document.getElementById(this.id)||document.createElement("canvas");this.i.classList.add("micrio");this.i.offset={top:0,left:0};this.i.micrio=this;this.container=this.e=a.container||this.i.parentNode||
document.body;this.e.classList.add("micrio-container");this.ma=this.i.getContext("2d");this.i.parentNode&&this.e==this.i.parentNode||this.e.appendChild(this.i);this.camera=this.f=new c.g(this);c.Eb&&(this.audio=this.gb=new c.Eb(this));c.Fb&&this.J.pointsOfInterest&&(this.pointsOfInterest=this.l=new c.Fb(this));this.thumbSrc=this.path+this.id+"/"+(this.W-1)+"/0-0.jpg";this.F=[];this.za=this.C=this.Ta=!1;this.Hb&&this.P()}function q(a){var b="",e;for(e in s)b+=a.replace(/\$/,s[e]);return b}function n(a,
b,e,c){var h=3*a,d=3*(e-a)-h,f=1-h-d,g=3*b,l=3*(c-b)-g,w=1-g-l;return function(a){for(var b=a,e=0,c;2>e;){c=b*(h+b*(d+b*f))-a;if(0.001>Math.abs(c))break;b-=c/(h+b*(2*d+3*f*b));e++}a=b;return a*(g+a*(l+a*w))}}(function(){for(var a=0,b=["ms","moz","webkit","o"],e=0;e<b.length&&!window.requestAnimationFrame;++e)window.requestAnimationFrame=window[b[e]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[b[e]+"CancelAnimationFrame"]||window[b[e]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||
(window.requestAnimationFrame=function(b){var e=(new Date).getTime(),c=Math.max(0,16-(e-a)),d=window.setTimeout(function(){b(e+c)},c);a=e+c;return d});window.cancelAnimationFrame||(window.cancelAnimationFrame=function(a){clearTimeout(a)})})();window.performance||(window.performance={});window.performance.now||(window.performance.now=Date.now);if("undefined"!==typeof window.Element&&!("classList"in document.documentElement)){Array.prototype.indexOf||(Array.prototype.indexOf=function(a,b){for(var e=
b||0,c=this.length;e<c;e++)if(this[e]===a)return e;return-1});var d=Array.prototype,t=d.indexOf,u=d.slice,v=d.push,x=d.splice,y=d.join,r=function(a){this.fb=a;if("string"==typeof a.className&&a.className!=this.Ia&&(this.Ia=a.className)){a=this.Ia.replace(/^\s+|\s+$/g,"").split(/\s+/);var b;for(b=0;b<a.length;b++)v.call(this,a[b])}};r.prototype={add:function(a){this.contains(a)||(v.call(this,a),a=u.call(this,0),this.fb.className=a.join(" "))},contains:function(a){return-1!==t.call(this,a)},remove:function(a){a=
t.call(this,a);-1!==a&&(x.call(this,a,1),a=u.call(this,0),this.fb.className=a.join(" "))},toString:function(){return y.call(this," ")}};window.DOMTokenList=r;(function(a,b,e){Object.defineProperty?Object.defineProperty(a,b,{get:e}):a.__defineGetter__(b,e)})(window.Element.prototype,"classList",function(){return new r(this)})}if(navigator.userAgent&&(d=navigator.userAgent.toLowerCase(),/msie/.test(d)||/rv\:11\.0/.test(d)||!window.dc)){var p=function(a,b){b=b||{bubbles:!1,cancelable:!1,detail:void 0};
var e=document.createEvent("CustomEvent");e.initCustomEvent(a,b.bubbles,b.cancelable,b.detail);return e};p.prototype=window.CustomEvent&&window.CustomEvent.prototype||window.Event.prototype;window.CustomEvent=p}Math.Fa=function(a,b){return Math.sqrt(a*a+b*b)};d=navigator.userAgent.toLowerCase();navigator.h={};navigator.h.webkit=/applewebkit/.test(d);navigator.h.firefox=/firefox/.test(d);navigator.h.safari=/safari/.test(d)&&!/chrome/.test(d);navigator.h.ie=/msie/.test(d)||/trident/.test(d)||/edge\//.test(d);
navigator.h.iemobile=/iemobile/.test(d);navigator.h.iOS=/ipad|iphone|ipod/.test(d);navigator.h.android=/android/.test(d);navigator.h.ie9=navigator.h.ie&&/ie 9/.test(d);navigator.h.iPad=/ipad/.test(d);navigator.h.mobile=navigator.h.iOS||navigator.h.android||navigator.h.iemobile;navigator.h.unknown=!navigator.h.webkit&&!navigator.h.firefox&&!navigator.h.ie&&!navigator.h.iOS&&!navigator.h.android;d={};d.transform="webkitTransform"in document.documentElement.style?"webkitTransform":"mozTransform"in document.documentElement.style?
"mozTransform":"msTransform"in document.documentElement.style?"msTransform":"transform";d.translate3d=navigator.h.ie9?["translate(",")"]:["translate3d(",",0)"];d.scale3d=navigator.h.ie9?["scale(",")"]:["scale3d(",",1)"];window.CSS=d;navigator.browser=navigator.h;navigator.h.iemobile&&(window.fc=Math.round(window.screen.availWidth/document.documentElement.clientWidth));c.prototype={P:function(){if(!this.Ta){this.Ta=!0;for(var a=0;a<this.W;a++)this.F.push(new c.ca(this,a));for(a=this.W-1;0<=a;a--)this.F[a].Bb=
a<this.W-1&&this.F[a+1].Bb+this.F[a+1].Vb||0;this.f.P();this.l&&this.l.P();return this.show()}},show:function(){if(!this.Ta)return this.P();if(this.C)return new Promise(function(a,b){b&&b("Already shown")});this.C=!0;this.e.appendChild(this.i);this.f.start();this.gb&&this.gb.P();this.l&&this.l.ic();this.f.va();return this.Gb=new Promise(function(a,b){this.za?a.bind(this)():(this.i.addEventListener("loaded",a.bind(this)),b&&this.i.addEventListener("error",b.bind(this)))}.bind(this))},Tb:function(){this.C&&
(this.C=!1,this.e.removeChild(this.i),this.l&&this.l.remove(),this.f.stop(),this.f.Ha())},N:function(){var a=!1,b=!1,e=[],c=[],d=this.Y,k=this.F.filter(function(a){return a.a.scale>=0.5/d});k.length||(k=[this.F[this.F.length-1]]);for(var f=0,g,l;f<k.length;f++)if(g=k[f].qb(),l=g.filter(function(a){return a&&a.loaded}),e=e.concat(l),c=c.concat(g.filter(function(a){return a&&!a.src})),l.filter(function(a){return 1==a.opacity}).length==g.length){a=0==f;break}this.ya&&k[f+1]&&(e=e.concat(k[f+1].qb().filter(function(a){return a&&
a.loaded})));e.reverse();c.reverse();for(f=0;f<e.length;f++)e[f].N(),1>e[f].opacity&&(b=!0);for(f=0;f<this.Kb&&f<c.length;f++)c[f].load();!a||b?this.f.H():this.za||(this.za=!0,this.i.classList.add("loaded"),this.i.dispatchEvent(new p("loaded",{detail:this.b})))}};window.Micrio=c;c.prototype.show=c.prototype.show;c.prototype.hide=c.prototype.Tb;c.ca=function(a,b){this.b=a;this.Wa=b;this.J=this.b.J&&this.b.J.levels&&this.b.J.levels[b];this.scale=Math.pow(2,b);this.Cb=[];this.Ua=[];this.a={scale:1,v:[0,
0,0,0]};this.L=a.L*this.scale;this.qa=[Math.ceil(a.width/this.L),Math.ceil(a.height/this.L)];this.Vb=this.qa[0]*this.qa[1];this.Ga=[this.L/this.b.width,this.L/this.b.height]};c.ca.prototype={qb:function(){this.Ua=[];var a=this.b.f.Ka;this.a.v[0]=Math.floor(a[0][0]/this.Ga[0]);this.a.v[1]=Math.ceil(a[1][0]/this.Ga[0]);this.a.v[2]=Math.floor(a[0][1]/this.Ga[1]);this.a.v[3]=Math.floor(a[1][1]/this.Ga[1]);for(var b=a=0;this.a.v[2]-1<this.a.v[3];this.a.v[2]++)for(b=this.a.v[0],a=this.qa[0]*this.a.v[2];b<
this.a.v[1];b++)this.Ua.push(this.Cb[a+b]||(this.Cb[a+b]=new c.ca.eb(this,b,this.a.v[2],this.J&&this.J.tiles[a+b])));return this.Ua}};c.ca.eb=function(a,b,e,c){this.s=a;this.x=b;this.y=e;this.J=c;this.loaded=!1;this.wb=0;this.opacity=(a.b.Aa||!a.b.za)&&1||0;this.height=this.width=0;this.Zb=b*this.s.b.L;this.$b=e*this.s.b.L;this.V=new Image;this.V.onload=this.onload.bind(this)};c.ca.eb.prototype={load:function(){var a=this.s.b,b=this.s,e=this.J,c=this.x,d=this.y;this.src=this.V.src=e&&e.url||a.path+
a.id+"/"+(a.data.isMontBlanc?a.W-b.Wa+7+"/"+c+"_"+d+".jpeg":a.cc?"TileGroup"+Math.floor((b.Bb+d*b.qa[0]+c)/256)+"/"+(a.W-b.Wa-1)+"-"+c+"-"+d+".jpg":b.Wa+"/"+c+"-"+d+".jpg")},onload:function(){this.width=this.V.naturalWidth||this.V.height;this.height=this.V.naturalHeight||this.V.width;this.loaded=!0;this.wb=performance.now()},N:function(a,b){this.loaded&&(a=a||this.s.b.f.j*this.s.scale,b=b||this.s.b.f.offset,this.s.b.Aa||(1>this.opacity&&(this.opacity=Math.min(1,(performance.now()-this.wb)/250)),this.s.b.ma.globalAlpha=
this.opacity),this.s.b.ma.drawImage(this.V,this.Zb*a-b[0],this.$b*a-b[1],this.s.b.ya&&this.width*a+1||this.width*a,this.s.b.ya&&this.height*a+1||this.height*a))}};var d=document.createElement("style"),s=["-webkit-","-moz-","-ms-",""];d.textContent=".micrio-container{"+q("$user-select:none;")+"-ms-content-zooming:none;-ms-touch-action:none;touch-action:none;}.micrio-container.hooked{cursor:move;"+q("cursor:$grab;")+"}.micrio-container.dragging{"+q("cursor:$grabbing;")+"}.micrio-container.fullscreen{width:100%;height:100%;}";
document.head.appendChild(d);c.Camera=c.g=function(a){this.b=a;this.offset=[0,0];this.position={x:0,y:0,z:0};this.G=Math.min(this.b.e.offsetWidth/this.b.width,this.b.e.offsetHeight/this.b.height);this.la=Math.max(this.b.e.offsetWidth/this.b.width,this.b.e.offsetHeight/this.b.height);this.j=a.Sa?this.la:this.G;this.paused=!1;this.sb=this.j;this.ka=this.X=this.U=!1;this.Ka=null;this.w=[0,0,0];this.xb="";this.Ja={left:0,top:0}};c.g.prototype={P:function(){c.g.Q&&(this.events=this.m=new c.g.Q(this));
this.p=new c.g.cb;this.N=this.N.bind(this);this.reset=this.reset.bind(this);this.ta=this.ta.bind(this);this.lb();this.onresize=this.onresize.bind(this);this.onresize()},start:function(){this.m&&(this.m.ea(),this.m.a.hash.Ib||(this.K(this.j),this.b.Sa?this.$([0.5,0.5]):this.t(0,0)));this.onresize()},stop:function(){this.p.stop();this.paused=!1;this.m&&this.m.stop()},pause:function(){this.p.pause()},Za:function(){this.p.Za()},va:function(){this.m&&this.b.Ub&&this.m.va();addEventListener("resize",this.onresize)},
Ha:function(){this.m&&this.m.Ha();removeEventListener("resize",this.onresize);document.removeEventListener(this.n.onchange,this.ta)},sa:function(a,b,e,c,d){this.stop();var k=this.D([this.b.e.offsetWidth/2,this.b.e.offsetHeight/2]),f=0,g=0,l=k[0],n=k[1],p=this.j,q=e>p;c=void 0!==c?c:1E4*Math.Fa(this.w[2]-e,Math.Fa(this.w[0]-a,this.w[1]-b))*(1/d);return this.p.add(this.position,{},c,function(c){f=m.ib(c);g=(q&&m.ac||m.bc)(c);this.position.x=l*(1-f)+a*f;this.position.y=n*(1-f)+b*f;this.position.z=p*
(1-g)+e*g;this.K(this.position.z);this.$([this.position.x,this.position.y],!0,!0);this.H()}.bind(this))},Pb:function(a){a=this.j==this.G?0:a||1E3;return this.b.f.sa(0.5,0.5,this.b.f.G,a)},Ob:function(a){a=this.j==this.G?0:a||1E3;return this.b.f.sa(0.5,0.5,this.b.f.la,a)},Na:function(a,b,c,d,h,k){this.stop();var f=this.D([this.b.e.offsetWidth/2,this.b.e.offsetHeight/2]),g={};void 0!==a&&(g.x=a);void 0!==b&&(g.y=b);void 0!==c&&(g.z=Math.min(h&&Infinity||1,Math.max(0,c)));this.position.x=f[0];this.position.y=
f[1];this.position.z=this.j;return this.p.add(this.position,g,d||5E3,function(){this.K(this.position.z,h);this.$([this.position.x,this.position.y],!0);this.H()}.bind(this),k)},reset:function(){this.K(this.sb);this.$([0.5,0.5])},D:function(a,b,c){c?(this.Ja=this.Pa(),a[0]-=this.Ja.left-(window.scrollX||window.pageXOffset),a[1]-=this.Ja.top-(window.scrollY||window.pageYOffset)):b&&(a[0]-=this.b.i.offset.left-(window.scrollX||window.pageXOffset),a[1]-=this.b.i.offset.top-(window.scrollY||window.pageYOffset));
...
a}.bind(l));this.B.push(l);this.I||this.start();return l.Xb}};var m=window.Beziers={ib:n(0.42,0,0.58,1),Mb:n(0.42,0,1,1),Nb:n(0,0,0.58,1),ac:n(0.74,0,0.79,0.12),bc:n(0,1,0.87,0.94)};m.easeInOut=m.ib;m.easeIn=m.Mb;m.easeOut=m.Nb;c.g.Q=function(a){this.f=a;this.b=a.b;this.aa=this.b.e;this.X=this.U=this.wa=!1;this.fa=!("onmousewheel"in document.body);this.rb="ontouchstart"in window||"onpointerdown"in window;this.a={c:{Ea:[0,0],q:null,O:null,I:null,jc:[0,0],gc:0,m:{start:["mousedown","touchstart"],move:["mousemove",
"touchmove"],stop:["mouseup","touchend"]},d:{Db:325,$a:null,timestamp:null,o:null,p:!1,scroll:[0,0],x:{offset:0,Z:0,r:0,frame:0,u:0,target:0,o:0},y:{offset:0,Z:0,r:0,frame:0,u:0,target:0,o:0}}},k:{q:null,O:null,yb:0,zb:0,hb:[0,0],ba:[0,0],Da:[0,0],Ma:0,Wb:0},M:{q:null,O:null},hash:{Va:!0,ka:!1,ra:["click","touchend"],A:null}};this.P()};c.g.Q.prototype={P:function(){this.Ra=this.Ra.bind(this);this.ia=this.ia.bind(this);this.oa=this.oa.bind(this);this.na=this.na.bind(this);this.La=this.La.bind(this);
this.da=this.da.bind(this);this.Ca=this.Ca.bind(this);this.Ba=this.Ba.bind(this);this.Xa=this.Xa.bind(this);this.ga=this.ga.bind(this);this.M=this.M.bind(this);this.ab=this.ab.bind(this);this.pa=this.pa.bind(this);this.xa=this.xa.bind(this);this.ea=this.ea.bind(this);this.ja=this.ja.bind(this)},stop:function(){cancelAnimationFrame(this.a.c.d.q);cancelAnimationFrame(this.a.c.q);cancelAnimationFrame(this.a.k.q);cancelAnimationFrame(this.a.M.q)},va:function(){if(!this.wa){this.wa=!0;for(var a in this.a.c.m.start)this.b.e.addEventListener(this.a.c.m.start[a],
this.oa);this.rb&&this.b.e.addEventListener("touchstart",this.Ca);this.b.e.addEventListener(this.fa?"DOMMouseScroll":"mousewheel",this.M);this.b.e.addEventListener("dblclick",this.pa);this.b.data.hookKeys&&document.addEventListener("keydown",this.xa);addEventListener("hashchange",this.ea);for(var b in this.a.hash.ra)document.documentElement.addEventListener(this.a.hash.ra[b],this.ja);this.b.e.classList.add("hooked")}},Ha:function(){if(this.wa){this.wa=!1;for(var a in this.a.c.m.start)this.b.e.removeEventListener(this.a.c.m.start[a],
this.oa);this.rb&&this.b.e.removeEventListener("touchstart",this.Ca);this.b.e.removeEventListener(this.fa?"DOMMouseScroll":"mousewheel",this.M);this.b.e.removeEventListener("dblclick",this.pa);this.b.data.hookKeys&&document.removeEventListener("keydown",this.xa);removeEventListener("hashchange",this.ea);for(var b in this.a.hash.ra)document.documentElement.removeEventListener(this.a.hash.ra[b],this.ja);this.b.e.classList.remove("hooked")}},Qa:function(a){if(a.touches.length)return a.touches[0]},oa:function(a){if(("mousedown"!=
a.type||1==a.which)&&this.f.G!=this.f.j){if(this.U)return a.touches&&2==a.touches.length&&this.da(a);this.U=!0;this.f.stop();for(var b in this.a.c.m.move)addEventListener(this.a.c.m.move[b],this.na);for(b in this.a.c.m.stop)addEventListener(this.a.c.m.stop[b],this.da);this.b.e.classList.add("dragging");a.touches&&(a=this.Qa(a));this.a.c.Ea=[a.clientX,a.clientY];this.a.c.d.y.Z=a.clientY;this.a.c.d.y.r=this.a.c.d.y.u=0;this.a.c.d.y.frame=this.a.c.d.y.offset;this.a.c.d.x.Z=a.clientX;this.a.c.d.x.r=this.a.c.d.x.u=
0;this.a.c.d.x.frame=this.a.c.d.x.offset;this.a.c.d.timestamp=performance.now();clearInterval(this.a.c.d.$a);this.a.c.d.$a=setInterval(this.Ra,100)}},na:function(a){cancelAnimationFrame(this.a.c.q);a.stopPropagation();a.preventDefault();a.touches&&(a=this.Qa(a));this.a.c.O=a;this.a.c.q=requestAnimationFrame(this.La)},La:function(a){a=this.a.c.O;this.f.t(this.a.c.Ea[0]-a.clientX,this.a.c.Ea[1]-a.clientY);this.f.H();this.a.c.Ea=[a.clientX,a.clientY];this.a.c.d.x.o=this.a.c.d.x.Z-a.clientX;if(2<this.a.c.d.x.o||
-2>this.a.c.d.x.o)this.a.c.d.x.Z=a.clientX,this.a.c.d.x.offset+=this.a.c.d.x.o;this.a.c.d.y.o=this.a.c.d.y.Z-a.clientY;if(2<this.a.c.d.y.o||-2>this.a.c.d.y.o)this.a.c.d.y.Z=a.clientY,this.a.c.d.y.offset+=this.a.c.d.y.o},da:function(a){if(this.U){this.U=!1;setTimeout(function(){}.bind(this));for(var b in this.a.c.m.move)removeEventListener(this.a.c.m.move[b],this.na);for(b in this.a.c.m.stop)removeEventListener(this.a.c.m.stop[b],this.da);this.b.e.classList.remove("dragging");a.touches&&(a=this.Qa(a));
clearInterval(this.a.c.d.$a);if(10<this.a.c.d.y.r||-10>this.a.c.d.y.r||10<this.a.c.d.x.r||-10>this.a.c.d.x.r)this.a.c.d.x.u=0.8*this.a.c.d.x.r,this.a.c.d.x.target=Math.round(this.a.c.d.x.offset+this.a.c.d.x.u),this.a.c.d.y.u=0.8*this.a.c.d.y.r,this.a.c.d.y.target=Math.round(this.a.c.d.y.offset+this.a.c.d.y.u),this.a.c.d.timestamp=performance.now(),this.a.c.d.q=requestAnimationFrame(this.ia)}},Ra:function(){this.a.c.d.o=1+(performance.now()-this.a.c.d.timestamp);this.a.c.d.timestamp=performance.now();
...
performance.now()-this.a.c.d.timestamp;if(this.a.c.d.x.u){var a=-this.a.c.d.x.u*Math.exp(-this.a.c.d.jb/this.a.c.d.Db);if(0.5<a||-0.5>a)this.a.c.d.scroll[0]=this.a.c.d.x.target+a,this.a.c.d.p=!0}this.a.c.d.y.u&&(a=-this.a.c.d.y.u*Math.exp(-this.a.c.d.jb/this.a.c.d.Db),0.5<a||-0.5>a)&&(this.a.c.d.scroll[1]=this.a.c.d.y.target+a,this.a.c.d.p=!0);this.scroll(this.a.c.d.scroll[0],this.a.c.d.scroll[1]);this.a.c.d.p&&(this.a.c.d.q=requestAnimationFrame(this.ia))},ob:function(a){if(2==a.touches.length)return Math.Fa(a.touches[0].clientX-
a.touches[1].clientX,a.touches[0].clientY-a.touches[1].clientY)/Math.Fa(this.aa.offsetWidth,this.aa.offsetHeight)},nb:function(a){this.a.k.ba[0]=Math.min(a.touches[0].clientX,a.touches[1].clientX);this.a.k.ba[1]=Math.min(a.touches[0].clientY,a.touches[1].clientY);this.a.k.Da[0]=Math.max(a.touches[0].clientX,a.touches[1].clientX);this.a.k.Da[1]=Math.max(a.touches[0].clientY,a.touches[1].clientY);return[this.a.k.ba[0]+(this.a.k.Da[0]-this.a.k.ba[0])/2,this.a.k.ba[1]+(this.a.k.Da[1]-this.a.k.ba[1])/
2]},Ca:function(a){if(this.X||2!=a.touches.length)return this.ga(a);a.stopPropagation();a.preventDefault();this.f.stop();this.X=!0;this.a.k.yb=this.ob(a);this.a.k.zb=this.f.j;this.a.k.hb=this.f.D(this.nb(a),!0);this.b.e.addEventListener("touchmove",this.Ba);this.b.e.addEventListener("touchend",this.ga);this.b.e.classList.add("pinching")},Ba:function(a){cancelAnimationFrame(this.a.k.q);a.stopPropagation();a.preventDefault();this.a.k.O=a;this.a.k.q=requestAnimationFrame(this.Xa)},Xa:function(a){a=this.a.k.O;
this.a.k.Ma=this.ob(a);if(this.a.k.Ma){this.f.K(this.a.k.zb*(this.a.k.Wb=this.a.k.Ma/this.a.k.yb));var b=this.f.ua(this.a.k.hb,!0);a=this.nb(a);this.f.t(b[0]-a[0],b[1]-a[1]);this.f.H()}},ga:function(){this.X&&(this.X=!1,this.b.e.removeEventListener("touchmove",this.Ba),this.b.e.removeEventListener("touchend",this.ga),this.b.e.classList.remove("pinching"))},M:function(a){this.U||this.X||0>(this.fa?30*-a.detail:a.wheelDelta)&&this.f.G==this.f.j||(a.preventDefault(),this.a.M.O=a,this.f.stop(),this.a.M.q=
requestAnimationFrame(this.ab))},ab:function(a){a=this.a.M.O;var b=!(this.f.n.T&&this.fa),c=this.f.D([a.clientX,a.clientY],b);this.f.zoom(this.fa?30*-a.detail:a.wheelDelta);b=this.f.ua(c,b);this.f.t(b[0]-a.clientX,b[1]-a.clientY);this.f.H()},pa:function(a){this.f.stop();1==this.f.j?!this.b.Jb||this.b.l&&this.b.l.tb&&this.b.l.C||this.f.Na(0.5,0.5,this.f.G,1E3):(a=this.f.D([a.clientX,a.clientY],!0),this.f.Na(a[0],a[1],2.5*this.f.j,400))},xa:function(a){if(!this.U&&!this.X){switch(a.keyCode){case 37:this.f.t(-this.aa.offsetWidth/
...
this.a.hash.Va)this.a.hash.A=location.hash.substr(1).split(","),3!=this.a.hash.A.length||(isNaN(this.a.hash.A[0])||isNaN(this.a.hash.A[1])||isNaN(this.a.hash.A[2]))||(this.a.hash.Ib=this.a.hash.A,this.f.stop(),a&&a.preventDefault(),this.a.hash.Va?(this.f.K(this.a.hash.A[2],!0),this.f.$(this.a.hash.A)):this.f.sa(this.a.hash.A[0],this.a.hash.A[1],this.a.hash.A[2])),this.a.hash.Va=!1,this.a.hash.ka=!1}};c.g.Q.prototype.hook=c.g.Q.prototype.va;c.g.Q.prototype.unhook=c.g.Q.prototype.Ha})();
